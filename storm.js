/* ═══════════════════════════════════════════════════════════════════════════
   ...
   and its reflection in the water, and him on the bike on the RenCen podium.
   ...
   HOW TO CHANGE IT — see STORM_CITY.md at the repo root. The short version:
     ...
     - the rider:     drawRider()        measured in wheelbase units
...
(function () {
  ...
  function drawSkyline(s, W, H, HZ, ZOOM) {
    ...
    // Parked on the podium roof with his REAR TYRE against the wall of the
    // right-hand RenCen tower. The rear axle sits 8 units behind the origin and
    // the tyre is 3.2 units across, so the back of the tyre is 11.2k left of the
    // origin — put the origin that far right of the tower's wall and the rubber
    // touches the brickwork.
    const k = Math.max(1.0, S) * 1.05;
    drawRider(s, RIGHT.x + RIGHT.w + 11.2 * k, HZ - 26 * S, k);
  }
